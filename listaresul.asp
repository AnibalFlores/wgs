...
<BODY bgcolor="#999999">
<%
clienteNro=request.form("txt_Nro")
...
<table width="100%"  border="0" cellspacing="0" cellpadding="0">
  <tr class="SloganTrebu">
    <td height="30" align="left"><div align="center" class="Titulo"><span class="verdana9"><strong>Resultado de la busqueda</strong></span></div></td>
  </tr>
<tr class="Msjerror">
...
<%end if%>
  <tr class="Texbuche">
    <td height="33"><div align="center">
      <input name="button" type=button class="btn" onClick="javascript:parent.main.location.href='buscarclientes.asp'" value="Volver">
    </div></td>
  </tr>
  <tr class="Texbuche">
    <td height="33"><div align="center">
